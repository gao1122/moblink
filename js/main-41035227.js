...
window.Base = {
    ...
    * */
     ...
     */
    OpenLink: function (url, type, title, windowOptions) {
        //打开链接
    ...
    fSubstringByWidth: function (str, width) {
        ...
        return Base.stringWidth(str) > _length ? Base.subStringWidth(str, 0, _length - 5) + "<label class=\"js-InfoTips\" title=\"" + str.replace(/"/g, "&quot;") + "\">...</label>" : str;
    },
    Decode: function (str) {
        //js自动的通用编码
        try {
        ...
        fUrlEncode: function (str) {
            ...
            for (var i = 0; i < str.length; i++) {
                ...
                if (parseInt("0x" + c) > 0x7f) {
                    ...
                    if (chr == " ") ret += "+";else if (strSpecial.indexOf(chr) != -1) ret += "%" + c.toString(16);else ret += chr;
                }
            }
            return ret;
        },
...
(function (window, undefined) {
  ...
  */
   ...
   */
	...
	jQuery.buildFragment = function (args, nodes, scripts) {
		...
		// If nodes[0] contains a valid object to assign to docs
		if (nodes && nodes[0]) {
			...
			for (var i = 0, elem; (elem = elems[i]) != null; i++) {
				...
				if (typeof elem === "string") {
					if (!rhtml.test(elem)) {
						...
						// Append wrapper element to unknown element safe docs fragment
						if (context === document) {
  ...
  */
	...
	if ("function" === "function" && __webpack_require__("XbS6") && __webpack_require__("XbS6").jQuery) {
...
window.Setting = {
    ...
    ImgPath: "../images/comm/",
    docTypeImg: ["pdf.gif", "docs.gif", "exc.gif", "ppt.gif", "jpg.gif", "txt.gif", "html.gif", "rar.gif", "rar.gif", "other.gif", "jpg.gif"],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_polyfill__ = __webpack_require__("briU");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_js_common_js__ = __webpack_require__("g5qz");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_highlight_js_styles_color_brewer_css__ = __webpack_require__("g/PF");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_highlight_js_styles_color_brewer_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_highlight_js_styles_color_brewer_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_css_docs_css__ = __webpack_require__("z0tR");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_css_docs_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__src_css_docs_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_css_base_css__ = __webpack_require__("dNEa");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_css_base_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__src_css_base_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_css_style_scss__ = __webpack_require__("cK4F");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_css_style_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__src_css_style_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__moblink_md__ = __webpack_require__("tOKY");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__moblink_md___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__moblink_md__);
...
const routeStting = [{ path: '/', component: __WEBPACK_IMPORTED_MODULE_8__moblink_md___default.a }];
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__public_js_Prototype__ = __webpack_require__("BEj1");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__public_js_Prototype___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__public_js_Prototype__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__public_js_Setting__ = __webpack_require__("LkKy");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__public_js_Setting___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__public_js_Setting__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__public_js_Base__ = __webpack_require__("4wSh");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__public_js_Base___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__public_js_Base__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__public_js_jquery1_7_2_jquery_js__ = __webpack_require__("BYbk");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__public_js_jquery1_7_2_jquery_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__public_js_jquery1_7_2_jquery_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__config__ = __webpack_require__("Pqsl");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__core__ = __webpack_require__("T2md");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__core___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__core__);
//项目公用
 //js原生类型扩展
 //公共配置
 //公共函数
...
module.exports = "<h1 class=bd-title id=content>MobLink.js</h1> <hr> <h4 id=->默认浮框</h4> <hr> <p>属性 <code>el</code> 表示网页上Element的id值,该字段为空或者不写则表示MobLink默认浮层上的打开按钮 (支持selector)。</p> <pre><code class=\"hljs language-js\">    MobLink([\n        {\n            <span class=hljs-attr>el</span>: <span class=hljs-string>''</span>,\n            <span class=hljs-attr>path</span>: <span class=hljs-string>'demo/a'</span>,\n            <span class=hljs-attr>params</span>: {\n                <span class=hljs-attr>key1</span>: <span class=hljs-string>'value1'</span>,\n                <span class=hljs-attr>key2</span>: <span class=hljs-string>'value2'</span>,\n            }\n        },\n        {\n            <span class=hljs-attr>el</span>: <span class=hljs-string>'#openAppBtn'</span>,\n            <span class=hljs-attr>path</span>: <span class=hljs-string>'demo/b'</span>,\n            <span class=hljs-attr>params</span>: {\n                <span class=hljs-attr>key1</span>: <span class=hljs-string>'value1'</span>,\n                <span class=hljs-attr>key2</span>: <span class=hljs-string>'value2'</span>,\n            }\n        },\n    ]);\n</code></pre> <h4 id=->调用</h4> <p>html</p> <pre><code class=\"hljs language-html\">    <span class=hljs-comment>&lt;!-- 在html上添加 --&gt;</span>\n    <span class=hljs-tag>&lt;<span class=hljs-name>script</span> <span class=hljs-attr>type</span>=<span class=hljs-string>\"text/javascript\"</span> <span class=hljs-attr>src</span>=<span class=hljs-string>\"//f.moblink.mob.com/v2_0_1/moblink.js?appkey=您自己的AppKey\"</span>&gt;</span><span class=\"undefined\"></span><span class=hljs-tag>&lt;/<span class=hljs-name>script</span>&gt;</span>\n</code></pre> <p>javascript</p> <pre><code class=\"hljs language-js\">    <span class=hljs-comment>// 页面上有多个元素需要跳转时使用数组方式,仅单个元素时可以使用对象的方式进行初始化</span>\n    <span class=hljs-comment>//方式1</span>\n    MobLink([...])\n    <span class=hljs-comment>//方式2</span>\n    MobLink({...})\n</code></pre> <h3 id=->配置</h3> <table> <thead> <tr> <th>参数</th> <th>类型</th> <th>可选值</th> <th>说明</th> </tr> </thead> <tbody> <tr> <td><code>el</code></td> <td>string, Array</td> <td><code>&#39;.class&#39;</code> <code>[&#39;#id1&#39;,&#39;#id2&#39;]</code></td> <td>跳转链接的承载元素</td> </tr> <tr> <td><code>path</code></td> <td>string</td> <td><code>site/page</code></td> <td>对应App里的路径（<code>必须一一对应</code>）</td> </tr> <tr> <td><code>params</code></td> <td>Object</td> <td><code>{key: value}</code></td> <td>网页需要带给客户端的参数</td> </tr> </tbody> </table> ";
